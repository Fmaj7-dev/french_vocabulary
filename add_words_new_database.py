...
with codecs.open(infile, encoding='utf-8') as inf:
    for line in inf:
        ...
        print("INSERT INTO `vocabulary` VALUES ("+str(vocabulary_offset)+", '"+french_replaced+"', '"+spanish_replaced+"', 2, 1, 2);")
        ...
        print("INSERT INTO `vocabulary_category` (`vocabulary_id`, `category_id`) VALUES ("+str(vocabulary_offset)+", 2);")
